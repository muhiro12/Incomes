...
struct ItemPredicateTest {
    ...
    func returnsAllItemsWithAllPredicate() throws {
        try service.create(date: date("2024-01-01T00:00:00Z"), content: "One", income: 100, outgo: 0, category: "A")
        try service.create(date: date("2024-02-01T00:00:00Z"), content: "Two", income: 200, outgo: 0, category: "B")
    ...
    func includesItemsBeforeDate() throws {
        let cutoff = date("2024-05-01T00:00:00Z")
        try service.create(date: date("2024-04-30T23:59:59Z"), content: "April", income: 1, outgo: 0, category: "Test")
    ...
    func includesMultipleItemsBeforeDate() throws {
        let cutoff = date("2024-05-01T00:00:00Z")
        try service.create(date: date("2024-04-01T00:00:00Z"), content: "EarlyApril", income: 0, outgo: 0, category: "Test")
        try service.create(date: date("2024-04-15T00:00:00Z"), content: "MidApril", income: 0, outgo: 0, category: "Test")
        try service.create(date: cutoff, content: "OnCutoff", income: 0, outgo: 0, category: "Test")
    ...
    func includesItemsAfterDate() throws {
        let cutoff = date("2024-05-01T00:00:00Z")
        try service.create(date: date("2024-05-01T00:00:01Z"), content: "After", income: 1, outgo: 0, category: "Test")
        try service.create(date: date("2024-04-30T23:59:59Z"), content: "Before", income: 1, outgo: 0, category: "Test")
    ...
    func includesMultipleItemsAfterDate() throws {
        let cutoff = date("2024-05-01T00:00:00Z")
        try service.create(date: cutoff, content: "OnCutoff", income: 0, outgo: 0, category: "Test")
        try service.create(date: date("2024-05-02T00:00:00Z"), content: "MaySecond", income: 0, outgo: 0, category: "Test")
        try service.create(date: date("2024-06-01T00:00:00Z"), content: "June", income: 0, outgo: 0, category: "Test")
    ...
    func excludesDifferentYearSameMonth() throws {
        try service.create(date: date("2023-02-15T00:00:00Z"), content: "2023Feb", income: 0, outgo: 0, category: "Test")
        try service.create(date: date("2024-02-15T00:00:00Z"), content: "2024Feb", income: 0, outgo: 0, category: "Test")

        let predicate = ItemPredicate.dateIsSameYearAs(date("2024-02-01T00:00:00Z"))
        let items = try service.items(.items(predicate))
        let contents = items.map(\.content)
    ...
    func includesAllMonthsInSameYear() throws {
        let baseDate = date("2024-01-01T00:00:00Z")
        try service.create(date: date("2024-01-15T00:00:00Z"), content: "January", income: 0, outgo: 0, category: "Test")
        try service.create(date: date("2024-06-01T00:00:00Z"), content: "June", income: 0, outgo: 0, category: "Test")
        try service.create(date: date("2023-12-31T23:59:59Z"), content: "LastYear", income: 0, outgo: 0, category: "Test")
    ...
    func includesOnlySameDayItems() throws {
        let baseDate = date("2024-04-01T00:00:00Z")
        try service.create(date: baseDate, content: "TargetDay", income: 1, outgo: 0, category: "Test")
        try service.create(date: date("2024-04-01T23:59:59Z"), content: "EndSameDay", income: 1, outgo: 0, category: "Test")
        try service.create(date: date("2024-03-31T23:59:59Z"), content: "DayBefore", income: 1, outgo: 0, category: "Test")
        try service.create(date: date("2024-04-02T00:00:00Z"), content: "DayAfter", income: 1, outgo: 0, category: "Test")
    ...
    func excludesSameTimeDifferentDay() throws {
        let baseDate = date("2024-04-01T00:00:00Z")
        try service.create(date: date("2024-03-31T00:00:00Z"), content: "PrevDay", income: 1, outgo: 0, category: "Test")
        try service.create(date: date("2024-04-02T00:00:00Z"), content: "NextDay", income: 1, outgo: 0, category: "Test")
    ...
    func includesEndOfDayUTC() throws {
        let baseDate = date("2024-04-01T00:00:00Z")
        let endOfDay = date("2024-04-01T23:59:59Z")
    ...
    func includesItemWithExactOutgoOnDate() throws {
        let date = date("2024-06-01T00:00:00Z")
    ...
    func excludesItemBeforeDateEvenIfOutgoMatches() throws {
        let cutoffDate = date("2024-06-01T00:00:00Z")
        try service.create(date: date("2024-05-31T23:59:59Z"), content: "Early", income: 0, outgo: 10_000, category: "Test")
    ...
    func includesItemsWithRepeatID() throws {
        try service.create(date: date("2024-01-01T00:00:00Z"), content: "RepeatOne", income: 0, outgo: 0, category: "Test")
        let repeatID = try service.item()!.repeatID

        try service.create(date: date("2024-02-01T00:00:00Z"), content: "NonRepeat", income: 0, outgo: 0, category: "Test")
    ...
    func includesOnlyFutureRepeatItems() throws {
        try service.create(date: date("2024-01-01T00:00:00Z"), content: "Past", income: 0, outgo: 0, category: "Test", repeatCount: 2)
        let repeatID = try service.item()!.repeatID

        let predicate = ItemPredicate.repeatIDAndDateIsAfter(repeatID: repeatID, date: date("2024-02-01T00:00:00Z"))
        let items = try service.items(.items(predicate))
        let contents = items.map(\.content)
