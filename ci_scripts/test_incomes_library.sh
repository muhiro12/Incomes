...
timestamp=$(date +%s)
result_bundle_path="$results_directory/TestResults_IncomesLibrary_${timestamp}.xcresult"
...
echo "Finished IncomesLibrary tests. Result bundle: $result_bundle_path"
