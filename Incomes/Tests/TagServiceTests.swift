...
struct TagServiceTests {
    ...
    @Test func tag() async throws {
        ...
        #expect(try context.fetchCount(Tag.descriptor(.all)) == 2)
    ...
    @Test func deleteAll() async throws {
        ...
        #expect(try context.fetchCount(Tag.descriptor(.all)) == 0)
    }
    ...
    @Test func mergeWhenTagsAreIdentical() async throws {
        ...
        #expect(try context.fetchCount(Tag.descriptor(.contentIsIn(["contentA"]))) == 1)
    ...
    @Test func mergeWhenTagsAreDifferent() async throws {
        ...
        #expect(try context.fetchCount(Tag.descriptor(.contentIsIn(["contentA"]))) == 1)
        #expect(try context.fetchCount(Tag.descriptor(.contentIsIn(["contentB"]))) == 1)
        #expect(try context.fetchCount(Tag.descriptor(.contentIsIn(["contentC"]))) == 1)
        ...
        #expect(try context.fetchCount(Tag.descriptor(.contentIsIn(["contentA"]))) == 1)
        #expect(try context.fetchCount(Tag.descriptor(.contentIsIn(["contentB"]))) == 0)
        #expect(try context.fetchCount(Tag.descriptor(.contentIsIn(["contentC"]))) == 0)
    ...
    @Test func mergeWhenTagsAreDuplicated() async throws {
        ...
        #expect(try context.fetchCount(Tag.descriptor(.contentIsIn(["contentA"]))) == 3)
    ...
    @Test func resolveAllDuplicatesWithExpectedUsage() async throws {
        ...
        #expect(try context.fetchCount(Tag.descriptor(.all)) == 6)
    ...
    @Test func resolveAllDuplicatesWithUnexpectedUsage() async throws {
        ...
        #expect(try context.fetchCount(Tag.descriptor(.all)) == 4)
    }
    ...
    @Test func findDuplicatesWithExpectedUsage() async throws {
        ...
        #expect(try context.fetchCount(Tag.descriptor(.all)) == 8)
